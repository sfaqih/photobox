            ...
            <div className='flex justify-center'>
                <div className='container p-10 bg-white border-2 border-stone-900 shadow-sm rounded-sm text-black'>
                    ...
                    <div className='grid grid-cols-3 gap-4'>
                        ...
                        <div className='form-group py-3'>
                            <label htmlFor="">Price Per Session</label><br />
                            <div className="w-72">
                                <TWInput
                                    min={1}
                        ...
                        <div className='form-group py-3'>
                            <label htmlFor="">Price Per Print</label><br />
                            <div className="w-72">
                                <TWInput
                                    min={1}
                                    defaultValue={config?.printPrice}
                                    type='number'
                                    size="lg"
                                    placeholder="5000"
                                    className=" !border-t-blue-gray-200 focus:!border-t-gray-900"
                                    onChange={(e) => setConfig({...config, printPrice: e.target.value})}
                                />
                            </div>                        
                        </div>                                                
                    </div>                                     
